...
public final class Fraction implements Comparable<Fraction>
  {
    ...
    public double toDouble()
      { // Fixes weird Long->Double NaN Bug
        if (this.numerator < 0){
          return -Double.longBitsToDouble(-this.numerator) /
                  Double.longBitsToDouble(this.denominator);
        }
        else{
          return Double.longBitsToDouble(this.numerator) /
                  Double.longBitsToDouble(this.denominator);
    ...
    public Fraction divide(Fraction f)
      {
        return new Fraction(this.numerator*f.getDenominator(),
